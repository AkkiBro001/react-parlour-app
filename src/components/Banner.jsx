    ...
    return (
        ...
        <div className="banner pt-20 relative h-[650px] overflow-hidden">
            ...
            <section className='h-full flex flex-col justify-center md:px-10 xs:px-5 gap-5'>
                <p className='sm:text-2xl font-bold text-blue-700 border-l-[3px] pl-3 border-blue-700'>Beauty Clinic</p>
                ...
                <button className='border-2 border-neutral-900 font-bold uppercase p-3 hover:bg-neutral-900 hover:text-white'>View Demo</button>
                </div>
            </section>
        </div>
